      ...
      <section className="pt-44 pb-44">
        ...
        <div className="px-4 md:flex-row md:pt-10 md:pb-5  flex-col flex items-center justify-between">
          <div className="font-[600] md:text-[2rem]  text-center pt-9 md:text-left text-[1.6rem] pb-7 ">
            <h2 className="font-recoleta md:font-bold font-light">
              Lets have a look at{" "}
            </h2>
            <h2 className=" font-recoleta md:font-bold font-light text-[#8470b4]  md:text-[2rem] text-center md:text-left text-[1.6rem] ">
              My Projects
            </h2>
          </div>
